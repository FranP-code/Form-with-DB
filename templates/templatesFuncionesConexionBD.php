...
function envio_datosA($connect, $day, $preceptora) {
...
function envio_datosE($connect, $dni, $name) {
...
function envio_datosC($connect, $id, $year, $division) {
...
function envio_datosL($connect, $id, $title, $amount) {
